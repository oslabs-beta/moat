...
[!Grafana](https://img.shields.io/badge/grafana-393946.svg?&style=for-the-badge&logo=grafana&logoColor=orange) (https://grafana.com/)
...
13. In Grafana, set up alerting rules for the panels on your dashboards. You can define alert conditions based on CloudWatch data. When an alert condition is met, Grafana can trigger actions, such as sending notifications or changing the state of a panel. 
14. Test the entire setup by triggering a CloudWatch alarm with excessive login attempts. 
